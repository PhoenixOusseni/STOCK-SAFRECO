    ...
    <div class="pagetitle">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                ...
                <form action="{{ route('gestions_clients.destroy', $client->id) }}" method="POST"
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Modification du Client "{{ $client->code }}"</h5>
                        <form action="{{ route('gestions_clients.update', $client->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <!-- Type de Client -->
