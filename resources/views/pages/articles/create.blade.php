                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('gestions_articles.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="prix_vente" class="small">Valeur residuelle (FCFA)</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="date_service" name="date_service" required>
                                </div>
                                <div class="col-md-4 mb-3">
                            ...
                            <div class="d-flex gap-2 mt-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-save"></i>&nbsp; Enregistrer l'immobilisation
                                </button>
