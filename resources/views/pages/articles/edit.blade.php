    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Modification de l'immobilisation "{{ $articleFinds->code }}"</h5>

                        {{-- Code bar de l'immobilisation ajouté ici --}}
                        ...
                        <form action="{{ route('gestions_articles.update', $articleFinds->id) }}" method="POST">
                            ...
                            <div class="mb-4" style="background: rgb(232, 240, 243); padding: 10px; border-radius: 5px;">
                                <label class="small fw-bold">Type d'immobilisation</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="prix_vente" class="small">Valeur résiduelle (FCFA)</label>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="date_entree" class="small">Date acquisition</label>
                                    <input type="date" class="form-control" id="date_entree" name="date_entree" value="{{ $articleFinds->date_entree }}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="date_service" class="small">Date mise en service</label>
                                    <input type="date" class="form-control" id="date_service" name="date_service" value="{{ $articleFinds->date_service }}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="famille" class="small">Groupe d'immobilisation</label>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-pencil-square"></i>&nbsp; Mettre à jour l'immobilisation
                                </button>
                            </div>
                        </form>
                    </div>
